...
<html>
  <head>
    ...
    <!-- Nucleo Icons -->
    <link href="{{ asset('admin-source/build/assets/css/nucleo-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin-source/build/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- Main Styling -->
    <link href="{{ asset('admin-source/build/assets/css/soft-ui-dashboard-tailwind.css?v=1.0.5') }}" rel="stylesheet" />
  ...
  <script src="{{ asset('admin-source/build/assets/js/plugins/chartjs.min.js') }}"></script>
  <!-- plugin for scrollbar  -->
  <script src="{{ asset('admin-source/build/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
  <!-- github button -->
