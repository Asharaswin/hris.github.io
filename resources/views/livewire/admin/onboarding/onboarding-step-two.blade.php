<div>
    ...
    @section('breadcrumb')
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Step Two</li>
        ...
        <h6 class="mb-0 font-bold capitalize">Step Two : Surat Izin Masuk</h6>
    @endsection
        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    ...
                    <i class="text-2x; material-icons-outlined icon ">description</i>
                                </td>
                                <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
