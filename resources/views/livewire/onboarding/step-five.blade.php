<div>
    @section('page-title')
        Onboarding Step Five - Eigen Tri Mathema
    @endsection
    ...
    <div class="section-main">
        <div class="max-w-7xl m-auto pt-5 px-2">
            ...
            <div class="bg-white overflow-hidden shadow-lg px-6 py-4 text-center md:text-end rounded-bl-xl rounded-br-xl">
                <a href="{{ route('onboarding.step-six') }}" class="rounded-full bg-lime-800 px-4 py-2 text-white">Step Selanjutnya</a>
            </div>
        </div>
    </div>
</div>
