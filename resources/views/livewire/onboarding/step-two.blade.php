        ...
        <div class="max-w-7xl m-auto pt-5 px-2">
            ...
            <div class="flex bg-white rounded-tl-xl rounded-tr-xl shadow-lg">
                <div class="w-5/6 md:w-4/6 mx-auto py-12 text-center">
                    <button type="button" class="mb-4" disabled>
                      ...
                      <p class="text-2xl font-bold">Mempersiapkan Surat Izin Anda</p>
                      <p>Kami sedang mempersiapkan surat izin untuk anda</p>
                </div>
            </div>
            
            <div class="bg-white overflow-hidden shadow-lg px-6 py-4 text-center md:text-end rounded-bl-xl rounded-br-xl">
                <a href="{{ route('onboarding.step-two-copy') }}" class="rounded-full bg-lime-800 px-4 py-2 text-white">Step Selanjutnya</a>
            </div>
        </div>
    </div>
</div>
